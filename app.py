...
from config import BTC_price_data_csv, BTC_mayer_values_csv, BTC_day_ratios_csv,\
                   BTC_currency_pair
...
def get_spot_price_for_date(date):
    price_data = coinbase_client.get_spot_price(currency_pair = BTC_currency_pair, date = date)
