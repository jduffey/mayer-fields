...
from config import ETH_price_data_csv, ETH_mayer_values_csv, ETH_day_ratios_csv,\
                   ETH_currency_pair
...
def get_spot_price_for_date(date):
    price_data = coinbase_client.get_spot_price(currency_pair = ETH_currency_pair, date = date)
